...
- **Chain of Thought (CoT)**: Técnica que pide a la IA razonar paso a paso antes de responder
...
- **Temperature**: Parámetro que controla la creatividad/aleatoriedad de las respuestas (más alto = más creativo, más bajo = más consistente)
...
Clase 01: [ROL][CONTEXTO][TAREA][FORMATO]
   ↓ evoluciona a ↓
Clase 02: RICE + Técnicas Avanzadas
